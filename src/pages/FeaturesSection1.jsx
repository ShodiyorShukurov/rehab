        ...
        <div className=" grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col w-full justify-between">
            <div>
              ...
              <h2 className="text-[36px] leading-[50px] font-semibold text-[#121418] max-w-[500px] mt-[16px]">
                Advanced Medical Care with Modern Facilities
              </h2>
            </div>
            <div>
              <p className="text-[#696969] mb-6 text-[16px] leading-[26px] max-w-[500px]">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[#007bbd] text-white p-6 rounded-[16px] h-[280px]">
              <h3 className="text-[24px] font-semibold leading-[34px]">Comfortable Facilities</h3>
            ...
            <div className="bg-[#F7F7F7] p-6 rounded-[16px] h-[280px]">
              <h3 className="text-[24px] font-semibold leading-[34px]" >Telemedicine Services</h3>
